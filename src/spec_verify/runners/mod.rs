...
pub use model::{
    ...
    NodePackageMetadata, NodeProjectMetadata, PreflightOutcome, ResolutionSource, RunnerResolution,
    RunnerRoutingPlan, RunnerSelection, RunnerSourceFile, RunnerWarning, RunnerWorkspace,
    RunnerWorkspaceMetadata, TestCommand, TestRunner, ValidatedRoute, WorkspaceMarkers,
};
